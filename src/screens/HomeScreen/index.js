  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.horizontalPaddingView}>
        ...
        />
        <Spacer height={5} />
        <Text style={values.h2Style}>The Social Set</Text>
        <Spacer height={5} />
        <FlatList
          data={social}
          showsVerticalScrollIndicator={false}
        ...
        />
        <Spacer height={5} />
        <Text style={values.h2Style}>The Finance Set</Text>
        <Spacer height={5} />
        <FlatList
          data={finance}
          showsVerticalScrollIndicator={false}
        ...
        />
        <Spacer height={5} />
        <Text style={values.h2Style}>Other Credentials</Text>
        <Text style={values.h4Style}>Add</Text>
        <Spacer height={5} />
      </View>
    </SafeAreaView>
  );
